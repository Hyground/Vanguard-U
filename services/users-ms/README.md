...
1. Hecho: mantener escrituras y validaciones criticas contra la ruta de escritura de Patroni.
...
7. Pendiente: no usar la ruta de lectura para login, registro, recuperacion de contrasena o cambios de rol.
