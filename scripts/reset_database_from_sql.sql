-- Vanguard-U database reset
-- WARNING: destructive script. It removes every table/object in schema public.
--
-- Use this only when the database must be rebuilt from the project source of truth.
-- Source of truth: sql.txt
--
-- Recommended order:
-- 1. Execute this script.
-- 2. Execute scripts/seed_stress_data.sql.
