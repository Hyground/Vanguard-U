  ...
  return (
    <div className="min-h-screen bg-base text-main">
      <main className="mx-auto grid min-h-screen w-full max-w-7xl grid-cols-1 lg:grid-cols-[1.1fr_26rem]">
        <section className="flex flex-col justify-center border-b border-border px-6 py-8 lg:border-b-0 lg:border-r lg:px-10 lg:py-10">
          ...
          <div className="max-w-2xl space-y-6">
            <div className="space-y-4">
              ...
              <p className="max-w-xl text-sec text-base leading-7">
                Bienvenido al portal central de Vanguard-U. Por favor, introduzca sus credenciales para acceder a sus servicios academicos y administrativos.
              </p>
            </div>
          </div>
        </section>
